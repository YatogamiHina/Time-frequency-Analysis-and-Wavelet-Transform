function y = hht(x_ori, t, thr)
    ...
    for step8 = 1:n_upper
        for step7 = 1:k_upper
            ...
            % Step3: local max curve for x(i) => lmaxc
            clear lmaxc;
            ...
            % Step5: local minimum curve for x(i) => lminc
            clear lminc; 
